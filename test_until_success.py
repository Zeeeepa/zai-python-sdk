#!/usr/bin/env python3
"""
Test Z.AI API with retries until we get a REAL FUCKING RESPONSE
"""
...
print("="*70)
print("🔥 Z.AI API - RETRY UNTIL WE GET A REAL RESPONSE")
print("="*70)
print()
        ...
        if chat_response.status_code == 200:
            ...
            if comp_response.status_code == 200:
                ...
                if 'choices' in result and len(result['choices']) > 0:
                    ...
                    print("⚠️ Unexpected format, retrying...")
                    print(f"Response: {json.dumps(result, indent=2)[:500]}")
            else:
                print(f"⚠️ Completion failed: {comp_response.status_code}")
                print(f"Response: {comp_response.text[:200]}")
        else:
